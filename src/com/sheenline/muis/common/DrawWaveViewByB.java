...
public class DrawWaveViewByB extends SurfaceView implements SurfaceHolder.Callback {
    // 刷新线程
...
//									}
    ...
    public DrawWaveViewByB(Context context) {
        super(context);

    }

    public DrawWaveViewByB(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private final void drawBViewAxs(Canvas canvas, float xlenx, float ylen, int scalex, String title) {
        ...
        paint1.setColor(Color.BLACK);// 颜色
        PathEffect effects1 = new DashPathEffect(new float[]{5, 5}, 1);
        ...
        PathEffect effects2 = new DashPathEffect(new float[]{21,9,3,9}, 1);
        paint2.setPathEffect(effects2);

        //绘制底波
        canvas.drawLine(0, yYPoint, xlen, yYPoint, paint);


        //01
        canvas.drawLine(0, yYPoint - 140 * scale, xlen, yYPoint - 140 * scale, paint1);

        //02

        canvas.drawLine(0, yYPoint - 176 * scale, xlen, yYPoint - 176 * scale, paint2);

//        371

        canvas.drawLine(0, yYPoint - 256 * scale, xlen, yYPoint - 256 * scale, paint1);


        //372

        canvas.drawLine(0, yYPoint - 316 * scale, xlen, yYPoint - 316 * scale, paint1);


        //373

        canvas.drawLine(0, yYPoint - 352 * scale, xlen, yYPoint - 352 * scale, paint2);


        //701

        canvas.drawLine(0, yYPoint - 388 * scale, xlen, yYPoint - 388 * scale, paint1);


        //702

        canvas.drawLine(0, yYPoint - 424 * scale, xlen, yYPoint - 424 * scale, paint2);

    }


    private final void drawBView(Canvas canvas, String[] datastr, float a, float b, int scale, String title) {
        // canvas.drawColor(Color.WHITE);// 设置背景颜色
