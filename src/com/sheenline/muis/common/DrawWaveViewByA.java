...
public class DrawWaveViewByA extends SurfaceView implements SurfaceHolder.Callback
	{
		// 刷新线程
		...
		public DrawWaveViewByA(Context context)
			{
				super(context);

			}

		public DrawWaveViewByA(Context context, AttributeSet attrs)
			{
				super(context, attrs);
